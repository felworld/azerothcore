...
public:
    ...
    // true when an aura of a higher rank of the same chain is applied and would be replaced by spellInfo
    [[nodiscard]] bool HasStrongerRankedAura(SpellInfo const* spellInfo, ObjectGuid casterGUID) const;
